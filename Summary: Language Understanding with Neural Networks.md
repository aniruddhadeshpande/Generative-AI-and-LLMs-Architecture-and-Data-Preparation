...
**Logits to Probabilities:** The network outputs logits for each class. These are transformed into probabilities using the **softmax function**:[23][12][18]

\[
P(y = i | x) = \frac{e^{z_i}}{\sum_{j} e^{z_j}}
\]

where \(z_i\) is the logit for class \(i\). Softmax exponentiates each logit (ensuring positivity) and normalizes by the sum, creating a probability distribution where all probabilities sum to 1.[24][23][12][18]
...
**Backward pass:** Compute gradients (`loss.backward()`)[17][18]
...
[1](https://ppl-ai-file-upload.s3.amazonaws.com/web/direct-files/attachments/81434540/e70db010-39ee-4a55-a9af-8c28d692d1a3/subtitle_Converting-Words-to-Features.txt)
...
[11](https://ppl-ai-file-upload.s3.amazonaws.com/web/direct-files/attachments/81434540/4b1bcebb-0363-47d7-bdf9-9a2eb06bdcc7/subtitle_Document-Categorization-Prediction-with-Torchtext.txt)
...
[17](https://ppl-ai-file-upload.s3.amazonaws.com/web/direct-files/attachments/81434540/1e4e5f6d-4912-47ac-b179-80bd39f9e0f7/subtitle_Training-the-Model-in-PyTorch.txt)
[18](https://ppl-ai-file-upload.s3.amazonaws.com/web/direct-files/attachments/81434540/a2de2c0e-790a-405c-b598-c71f2d4a6260/subtitle_Document-Categorization-Training-with-Torchtext.txt)
